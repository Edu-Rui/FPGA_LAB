...
REM
REM Generated by Vivado on Wed Sep 17 19:26:50 -0400 2025
...
echo "xvhdl --incr --relax -prj lab02c_vhdl.prj"
call xvhdl  --incr --relax -prj lab02c_vhdl.prj -log xvhdl.log
